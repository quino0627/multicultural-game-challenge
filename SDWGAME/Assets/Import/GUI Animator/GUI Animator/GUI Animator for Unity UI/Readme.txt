------------------------------------------------------------------
GUI Animator for Unity UI 1.1.5
------------------------------------------------------------------

	Quickly and easily add professional animations to Unity UI. This package will save your time.
	...
	Note:
		...
		ï Users who upgraded from old versions, please delete "GSuiEditor" script in "Scripts/Editor" folder.
