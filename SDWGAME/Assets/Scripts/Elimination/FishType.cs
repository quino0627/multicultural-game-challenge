    ...
    void Awake()
    {
        ...
        switch (level)
        {
            case 0:
                ...
                {
                    choices[i].transform.GetChild(2).gameObject.GetComponent<SpriteRenderer>().sprite = Fish1IdleRedSprite;
                    choices[i].transform.GetChild(2).gameObject.GetComponent<Animator>().runtimeAnimatorController = fish1IdleRedAnimatorController;
            ...
            case 1:
                for (int i = 0; i < NUM_OF_CHOICES; i++)
                {
                    choices[i].transform.GetChild(2).gameObject.GetComponent<SpriteRenderer>().sprite = Fish4IdleYellowSprite;
                    choices[i].transform.GetChild(2).gameObject.GetComponent<Animator>().runtimeAnimatorController = fish4IdleYellowAnimatorController;
            ...
            case 2:
                for (int i = 0; i < NUM_OF_CHOICES; i++)
                {
                    choices[i].transform.GetChild(2).gameObject.GetComponent<SpriteRenderer>().sprite = Fish2IdleGreenSprite;
                    choices[i].transform.GetChild(2).gameObject.GetComponent<Animator>().runtimeAnimatorController = fish2IdleGreenAnimatorController;
